...
void
RigidBodyFit::fitCoordinates(const Field<real>        &reference,
...
real
RigidBodyFit::bestFitPotential() const
{
    return bestFitPotential_;
}

Quaternion
RigidBodyFit::fitOrientation() const
{
    return orientation_;
}

RVec
RigidBodyFit::fitTranslation() const
{
    return translation_;
}
