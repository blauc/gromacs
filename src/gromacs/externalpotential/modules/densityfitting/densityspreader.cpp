...
DensitySpreader::DensitySpreader(const FiniteGrid<DIM> &grid, int numberOfThreads, int n_sigma, real sigma) : gauss_transform_ {new std::vector < std::unique_ptr < GaussTransform>>}, simulated_density_buffer_ {
