...
// {
//
// // const GridDataReal3D &InvertedDensity::evaluateDensityDifferential(
...
// //     auto referenceGridDataReal3D = GridDataReal3D(reference);
// //     auto sumOverGrid       = [referenceGridDataReal3D, centerOfMass, translation, orientation] (const real sum, const RVec r){
// //             return sum + referenceGridDataReal3D.getLinearInterpolationAt(orientation.shiftedAndOriented(r, centerOfMass, translation));
// //         };
...
// //         {
// //             result += GridDataReal3D(reference).getLinearInterpolationAt(orientation.shiftedAndOriented(*(*atom).xTransformed, centerOfMass, translation));
// //         }
// //     }
// //     return result;
// // };
