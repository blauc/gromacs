...
class ForceDensity
{
    ...
    private:
        ...
        real sigma_;
        std::array<GridDataReal3D, DIM>                    forces_;
        std::array<GridDataComplex3D, DIM>                 forcesFT_;
        std::array<GridDataComplex3D, DIM>                 convolutionDensity_;
        GridDataComplex3D                                  densityGradientFT_;
