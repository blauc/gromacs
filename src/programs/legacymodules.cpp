 ...
 *
 * Copyright (c) 2012,2013,2014,2015,2016,2017,2018, by the GROMACS development
 * team, led by Mark Abraham, David van der Spoel, Berk Hess, and Erik Lindahl,
...
public:
  ...
  void
  writeHelp(const gmx::CommandLineHelpContext & /*context*/) const override {
    printMessage();
  }
...
private:
  void printMessage() const {
    std::fprintf(stderr,
                 ...
                 "  "
                 "http://jenkins.gromacs.org/job/Documentation_Nightly_master/"
                 "javadoc/user-guide/cmdline.html#command-changes\n"
 ...
 * \param[in] shortDescription One-line description for the new module.
 */
void registerModuleNoNice(
    gmx::CommandLineModuleManager *manager,
    gmx::CommandLineModuleManager::CMainFunction mainFunction, const char *name,
...
void registerLegacyModules(gmx::CommandLineModuleManager *manager) {
  ...
  registerModuleNoNice(manager, &gmx_mdrun, "mdrun",
                       "Perform a simulation, do a normal mode analysis or an "
                       "energy minimization");
  ...
  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::pdb2gmxInfo::name, gmx::pdb2gmxInfo::shortDescription,
      &gmx::pdb2gmxInfo::create);

  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::mapcompareInfo::name, gmx::mapcompareInfo::shortDescription,
      &gmx::mapcompareInfo::create);

  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::mapconvertInfo::name, gmx::mapconvertInfo::shortDescription,
      &gmx::mapconvertInfo::create);

  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::mapcreateInfo::name, gmx::mapcreateInfo::shortDescription,
      &gmx::mapcreateInfo::create);

  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::mapinfoInfo::name, gmx::mapinfoInfo::shortDescription,
      &gmx::mapinfoInfo::create);

  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::mapdiffInfo::name, gmx::mapdiffInfo::shortDescription,
      &gmx::mapdiffInfo::create);

  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::maplogInfo::name, gmx::maplogInfo::shortDescription,
      &gmx::maplogInfo::create);

  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::mapnormInfo::name, gmx::mapnormInfo::shortDescription,
      &gmx::mapnormInfo::create);

  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::mapmulInfo::name, gmx::mapmulInfo::shortDescription,
      &gmx::mapmulInfo::create);

  gmx::ICommandLineOptionsModule::registerModuleFactory(
      manager, gmx::mapsqrtInfo::name, gmx::mapsqrtInfo::shortDescription,
      &gmx::mapsqrtInfo::create);
  ...
  registerModule(
      manager, &gmx_helixorient, "helixorient",
...

  {
    ...
    group.addModuleWithDescription("editconf",
  ...
  }
  {
    ...
    group.addModuleWithDescription(
        "mdrun", "(Re)calculate energies for trajectory frames with -rerun");
  }
  {
    gmx::CommandLineModuleGroup group =
  ...
  }
  {
    ...
    group.addModule("grompp");
    group.addModuleWithDescription(
        "mdrun", "Find a potential energy minimum and calculate the Hessian");
  }
}
